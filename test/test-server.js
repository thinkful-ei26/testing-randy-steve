...
describe('Recipes', function() {
  ...
  it('should create new recipe on POST', function() {
    const newItem = { name: 'coffee', ingredients: ['coffeebeans', 'water'] };
  ...
  it('should update a recipe on PUT', function() {
    ...
    return chai
      ...
      .then(function(res) {
        ...
        // expect(res.body).to.be.a('object');
        // expect(res.body).to.deep.equal(updateData);
        // expect(res.body.headers).to.include('application/json');
      });
  });
